...
void I2C_GPIO(void )
{
        ...
        PAD_AFConfig(PAD_PA,GPIO_Pin_9, PAD_AF1); // PAD Config - LED used 2nd Function
        
        GPIO_InitDef.GPIO_Pin = GPIO_Pin_10; // Set to Pin_9 (SCL0))
        GPIO_InitDef.GPIO_Mode = GPIO_Mode_OUT; // Set to Mode Output
        GPIO_Init(GPIOA, &GPIO_InitDef);
        PAD_AFConfig(PAD_PA,GPIO_Pin_10, PAD_AF1); // PAD Config - LED used 2nd Function
...
void GPIO_I2C(void )
{
       ...
       GPIO_InitDef.GPIO_Mode = GPIO_Mode_OUT; // Set to Mode Output
       GPIO_Init(GPIOA, &GPIO_InitDef);
       PAD_AFConfig(PAD_PA,GPIO_Pin_9, PAD_AF0); // PAD Config - LED used 2nd Function
        
       GPIO_InitDef.GPIO_Pin = GPIO_Pin_10; // Set to Pin_9 (SCL0))
       GPIO_InitDef.GPIO_Mode = GPIO_Mode_OUT; // Set to Mode Output
       GPIO_Init(GPIOA, &GPIO_InitDef);
       PAD_AFConfig(PAD_PA,GPIO_Pin_10, PAD_AF0); // PAD Config - LED used 2nd Functio
